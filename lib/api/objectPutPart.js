    ...
    return async.waterfall([
        ...
        splitter, next) => {
            if (config.backends.data === 'multiple') {
                ...
                objectKey, uploadId, partNumber, destinationBucket, log,
                (err, partInfo) => {
                    if (err) {
        ...
        (destinationBucket, dataGetInfo, hexDigest, cipherBundle, partKey,
            ...
            const omVal = {
                // Version 4 adds number-subparts for Azure data backend
                'md-model-version': 4,
                partLocations,
                'key': partKey,
                ...
                'content-length': size,
                'number-subparts': dataGetInfo.numberSubParts,
            };
