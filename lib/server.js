...
function patchConfiguration(newConf) {
    ...
    console.log('applied configuration version', _config.overlayVersion);
}
...
function applyRemoteConfiguration() {
...
class S3Server {
    ...
    startup(port, ipAddress) {
        ...
        setInterval(reportInterval, 30000);
        setInterval(applyRemoteConfiguration, 10000);
    }
